...
<div class="block">
  ...
  <NAMESPACE-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></NAMESPACE-cascader>
</div>
<div class="block">
...
```html
<NAMESPACE-cascader :options="options"></NAMESPACE-cascader>
...
:::demo
```html
<NAMESPACE-cascader :options="options" clearable></NAMESPACE-cascader>
...
```html
<NAMESPACE-cascader :options="options" :show-all-levels="false"></NAMESPACE-cascader>
...
```html
<NAMESPACE-cascader :props="props"></NAMESPACE-cascader>
...
```html
<NAMESPACE-cascader :options="options">
...
```html
<NAMESPACE-cascader-panel :options="options"></NAMESPACE-cascader-panel>
