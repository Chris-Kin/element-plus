...
:::demo
```html
<NAMESPACE-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></NAMESPACE-tree>
...
<div class="buttons">
  <NAMESPACE-button @click="getCheckedNodes">通过 node 获取</NAMESPACE-button>
  <NAMESPACE-button @click="getCheckedKeys">通过 key 获取</NAMESPACE-button>
  <NAMESPACE-button @click="setCheckedNodes">通过 node 设置</NAMESPACE-button>
  <NAMESPACE-button @click="setCheckedKeys">通过 key 设置</NAMESPACE-button>
  <NAMESPACE-button @click="resetChecked">清空</NAMESPACE-button>
</div>
