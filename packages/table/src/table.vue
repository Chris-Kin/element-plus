<template>
  <div
    :class="[
      {
        'NAMESPACE-table--fit': fit,
        'NAMESPACE-table--striped': stripe,
        'NAMESPACE-table--border': border || isGroup,
        'NAMESPACE-table--hidden': isHidden,
        'NAMESPACE-table--group': isGroup,
        'NAMESPACE-table--fluid-height': maxHeight,
        'NAMESPACE-table--scrollable-x': layout.scrollX.value,
        'NAMESPACE-table--scrollable-y': layout.scrollY.value,
        'NAMESPACE-table--enable-row-hover': !store.states.isComplex.value,
        'NAMESPACE-table--enable-row-transition':
          (store.states.data.value || []).length !== 0 &&
          (store.states.data.value || []).length < 100,
      },
      tableSize ? `NAMESPACE-table--${tableSize}` : '',
    ]"
  ...
  >
    ...
    <div
      ...
      class="NAMESPACE-table__header-wrapper"
    >
      <table-header
        ref="tableHeader"
        :border="border"
    ...
    <div ref="bodyWrapper" :style="[bodyHeight]" class="NAMESPACE-table__body-wrapper">
      <table-body
        :context="context"
      ...
      <div
        ...
        class="NAMESPACE-table__empty-block"
      >
        <span class="NAMESPACE-table__empty-text">
      ...
      <div
        v-if="$slots.append"
        ref="appendWrapper"
        class="NAMESPACE-table__append-wrapper"
      >
    ...
    <div
      ...
      ref="footerWrapper"
      v-mousewheel="handleHeaderFooterMousewheel"
      class="NAMESPACE-table__footer-wrapper"
    >
      <table-footer
        :border="border"
        :default-sort="defaultSort"
    ...
    <div
      ...
      class="NAMESPACE-table__fixed"
    >
      <div
        v-if="showHeader"
        ref="fixedHeaderWrapper"
        class="NAMESPACE-table__fixed-header-wrapper"
      >
        <table-header
      ...
      <div
        ...
        class="NAMESPACE-table__fixed-body-wrapper"
      >
        <table-body
          :highlight="highlightCurrentRow"
          :row-class-name="rowClassName"
        ...
        <div
          ...
          class="NAMESPACE-table__append-gutter"
        ></div>
      </div>
      <div
        v-if="showSummary"
        ...
        class="NAMESPACE-table__fixed-footer-wrapper"
      >
        <table-footer
          :border="border"
          :store="store"
    ...
    <div
      ...
      class="NAMESPACE-table__fixed-right"
    >
      <div
        v-if="showHeader"
    ...
    <div
      ...
      class="NAMESPACE-table__fixed-right-patch"
    ></div>
    <div
      v-show="resizeProxyVisible"
      ref="resizeProxy"
      class="NAMESPACE-table__column-resize-proxy"
    ></div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props: TableProps) {
    ...
    const tableId = 'NAMESPACE-table_' + tableIdSeed++
